...
see the `intel` branch for an intel-compatible set of files.  
(basically brew installs things in a different place on Intel vs M1 architectures is all, and so some sourcing paths are different)
